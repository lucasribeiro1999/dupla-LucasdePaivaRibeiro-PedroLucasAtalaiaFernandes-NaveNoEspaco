/* ======================================================================
   ...
   + Cronômetro no HUD
   + Recorde (high score) salvo em localStorage
   + Tela de Game Over mostra Score, Recorde e "NOVO RECORDE!" quando aplicável
====================================================================== */
...
(() => {
  ...
  // ===== Cronômetro + HighScore persistente =====
  ...
  function draw() {
    ...
    if (gameState === GameState.MENU) {
      drawTitle('NAVE NO ESPAÇO', 'Pressione ENTER ou clique em Jogar');
      return;
    }
    if (gameState === GameState.GAMEOVER) {
      drawHUD(); // mostra Score/HP/Tempo finais no topo
      drawGameOverOverlay();
      return;
    }
